"""Project GIGDIS alpha0.1.0 service entrypoint (stdlib HTTP server)."""
...
from pipeline import aggregate_by_country, build_adaptive_panel, fetch_events
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        if parsed.path == "/api/v1/hotspots":
            ...
            return self._json(
                {
                    "last_refresh": STATE["last_refresh"],
                    "countries": aggregate_by_country(events),
                }
            )
        ...
        if parsed.path == "/api/v1/panel":
            ...
            return self._json(build_adaptive_panel(events, viewport_country))
